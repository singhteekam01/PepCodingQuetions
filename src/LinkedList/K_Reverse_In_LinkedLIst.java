...
public class K_Reverse_In_LinkedLIst  {
    ...
    public static void kReverse(LinkedList list,int k){
        LinkedList currList = new LinkedList(),prevList = null;
        ...
        while(list.size >0){
            ...
            if(k > list.size){
                int sz = list.size;
                while(sz-->0){
                    int fEle = list.getFirst();
                    list.removeFirst();
                    currList.addLast(fEle);
                }
            }else {
                int count = k;
                while (count-- > 0) {
            ...
            if (prevList == null) {
                ...
                prevList.tail.next = currList.head;
                prevList.size = currList.size+prevList.size;
                prevList.tail = currList.tail;
                currList = new LinkedList();
            }
        }
        list.head = prevList.head;
        list.tail = prevList.tail;
        list.size = prevList.size;
    }
