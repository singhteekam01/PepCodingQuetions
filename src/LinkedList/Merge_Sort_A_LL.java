...
public class Merge_Sort_A_LL  {
    ...
    public static LinkedList mergeSort(LinkedList l, Node head, Node tail){
        if(head == tail){
        ...
        LinkedList fsh = mergeSort(l,head,midNode);
        LinkedList ssh = mergeSort(l,midNode.next,tail);

        return mergeTwoList(fsh,ssh);
    }
    public static void main(String[] args) {
        ...
        LinkedList res = mergeSort(list1, list1.head,list1.tail);
        res.display();
    }
}
